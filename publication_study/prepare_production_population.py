...
SOURCE = ROOT / "addition_inputs" / "IHME-GBD_2023_DATA-a9a792bb-1.zip"
OUTPUT = ROOT / "data" / "GBD_2023_population_China_US.csv"
...
def main() -> None:
    ...
    print(f"Raw ZIP SHA-256: {file_sha256(SOURCE)}")
