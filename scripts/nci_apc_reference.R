# NCI APC Web Tool source, unchanged except for this attribution header.
# Revision: 9e86d92d3f95b76b610a37f6e3c539ee126b5efd
# https://github.com/CBIIT/nci-webtools-dceg-age-period-cohort/blob/9e86d92d3f95b76b610a37f6e3c539ee126b5efd/apc/apc.R
# NCI software transfer terms: https://dceg.cancer.gov/tools/analysis/apc/license
apc2 <- function(R, ...)
{
  PVP <- checkPVPPAIRS(R, ...)
  D <- designmatrix(PVP)
