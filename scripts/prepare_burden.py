...
OUTPUT = DATA_DIR / "GBD_2023_schizophrenia_fine_age_China_US.csv"

BASE_EXPORT = DATA_DIR / "IHME-GBD_2023_DATA-774041bd-1.zip"
CORRECTION_EXPORT = DATA_DIR / "IHME-GBD_2023_DATA-22ef74c2-1.zip"
...
def required_index() -> pd.MultiIndex:
    ...
    records.extend(
        product(LOCATIONS, SEXES, ("All ages",), MEASURES, ("Number",), YEARS)
    )
    records.extend(
